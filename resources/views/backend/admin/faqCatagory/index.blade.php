...
@section('content')
    ...
    <div class="container-fluid">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-hover table-bordered align-middle" id="orderMenage" class="display">
                        ...
                        <tbody>
                            ...
                            @forelse($faqCatagories as $key => $category)

                                @php
                                    $serial = $faqCatagories->firstItem() + $key;
                                @endphp
                                ...
                                <tr>
                                    ...
                                    <!-- Status -->
                                    <td class="text-center">
                                        <form action="{{ route('faq.catagory.toggle-status', $category->id) }}" method="POST" id="status-form-{{ $category->id }}">
                                            @csrf
                                            @method('PATCH')
                                    ...
                                    <td class="text-center">
                                        <!-- Edit Button -->
                                        <a href="{{ route('faq.catagory.edit', $category->id) }}"
                                        ...
                                        <!-- Delete Button -->
                                        <form action="{{ route('faq.catagory.destroy', $category->id) }}"
                                            method="POST"
        ...
        <!-- Pagination -->
        <div class="mt-3">
            {{ $faqCatagories->withQueryString()->links() }}
        </div>
