            ...
            <div class="container py-5">
                <div class="pb-4 mb-4" style="border-bottom: 1px solid rgba(226, 175, 24, 0.5) ;">
                    <div class="row g-4">
                        <div class="col-lg-3">
                            <a href="#">
                                <h1 class="text-primary mb-0">{{ $setting->site_name ?? '' }}</h1>
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex flex-column text-start footer-item">
                            ...
                            {{-- <a class="btn-link" href="{{ route('web.shop-details', $product->id) }}">Shop details</a> --}}
                            <a class="btn-link" href="{{ route('web.shopping') }}">Shopping Cart</a>
